...
class WeekData {
	...
	public var overlayColor:Array<Int>;
	...
	public static function createWeekFile():WeekFile {
		var weekFile:WeekFile = {
			...
			weekBefore: 'tutorial',
			description: 'Your New Week',
			weekName: 'Custom Week',
			overlayColor: [146, 113, 253],
			startUnlocked: true,
	...
	public function new(weekFile:WeekFile, fileName:String) {
		...
		description = weekFile.description;
		weekName = weekFile.weekName;
		overlayColor = weekFile.overlayColor;
